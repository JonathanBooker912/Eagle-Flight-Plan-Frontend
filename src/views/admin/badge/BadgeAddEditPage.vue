<script setup>
    ...
    const removeTask = (task) => {
        ruleTasks.value = ruleTasks.value.filter(
            (t) => t.task.id !== task.task.id
        );
    };
        ...
        if (!props.isAdd) {
            try {
                ...
                if (formData.value.imageName) {
                    response = await fileServices.getFileForName(
...
<template>
                ...
                <v-expansion-panels class="mb-4 rounded-lg">
                    <v-expansion-panel class="mb-2">
                        <v-expansion-panel-title
                            >Experiences</v-expansion-panel-title
                        >
                        <v-expansion-panel-text>
                            <v-row
                            ...
                            >
                                ...
                                <div class="ma-2 d-flex">
                                    ...
                                    <v-btn
                                        ...
                                        icon="mdi-delete"
                                        @click="
                                            removeExperience(ruleExperience)
                                        "
                                    >
                                    </v-btn>
                                </div>
    ...
    <AddTaskToBadge @addTaskToBadge="handleAddTaskToBadge" />
    <AddExperienceToBadge @addExperienceToBadge="handleAddExperienceToBadge" />
</template>
