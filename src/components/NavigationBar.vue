...
var student = [
    ...
    let baseRoute = `/${role}`;
    let routeToPush = roleRoutes[role].find(route => route["link-text"] === linkText)?.["route-name"];
...
<template>
  <div class="userNav">
    ...
    <div id="profile" class="navOption profile" @click="newNavSection('profile')"> 
    ...
    <div id="flightPlan" class="navOption flightPlan" @click="newNavSection('flightPlan')">
        <i class="pi pi-telegram"></i>
        <p>Flight Plan</p>
    </div>
    <div id="calendar" class="navOption calendar" @click="newNavSection('calendar')">
        <i class="pi pi-calendar"></i>
        <p>Calendar</p>
    </div>
    <div id="notifs" class="navOption notifs" @click="newNavSection('notifications')">
    ...
    <div id="logout" class="navOption logout" style="margin-top: auto;"@click="newNavSection()">
