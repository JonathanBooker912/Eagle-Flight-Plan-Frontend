    ...
    const handleSubmit = async () => {
        try {
            if (flightPlanItem.value.task.submissionType === "text") {
                ...
                const submissions = fileNames.map((fileName) => ({
                    ...submissionData,
                    value: fileName
                }));
            ...
            <v-card-text>
                <v-fade-transition mode="out-in">
                    ...
                    <div v-else>
                        ...
                        <v-file-upload
                            v-else-if="
                                flightPlanItem.task.submissionType === 'files'
                            "
                            v-model="files"
                            label="Upload Files"
                            multiple
                        ...
                        <div v-else>
                            ...
                            >
                                <v-expansion-panel class="mb-2">
                                    <v-expansion-panel-title
                                        >Reflection</v-expansion-panel-title
                                    >
                                    <v-expansion-panel-text
                                        class="bg-backgroundDarken"
                                    >
                                        <v-textarea
                                            v-model="reflectionText"
                                            label="Reflection"
                            ...
                            >
                                <v-expansion-panel class="mb-2">
                                    <v-expansion-panel-title
                                        >File Upload</v-expansion-panel-title
                                    >
                                    <v-expansion-panel-text
                                        class="bg-backgroundDarken"
                                    >
